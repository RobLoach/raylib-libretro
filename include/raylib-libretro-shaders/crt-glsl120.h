...
"\tvec4 intensity;\n"
"\t\n"
"\tif (fract(gl_FragCoord.y * (0.5 * 1.5 / 3.0)) > 0.5) intensity = vec4(0.0);\n"
"\telse intensity = smoothstep(0.2, 0.5, rgba);\n"
"\n"
...
"\n"
"\tfloat gamma_exp = 1.0 / (2.0 * Gamma - MonitorGamma);\n"
"\tfloat luma = dot(mul_res, vec3(0.299, 0.587, 0.114));\n"
"\tfloat scale = pow(max(luma, 1e-5), gamma_exp) / max(luma, 1e-5);\n"
"\tmul_res = clamp(mul_res * scale, 0.0, 1.0);\n"
"\tif (Border) mul_res *= cval;\n"
"\n"
