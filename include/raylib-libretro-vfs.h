/**********************************************************************************************
*
*   raylib-libretro-vfs - Virtual File System for libretro, built for raylib.
*
*   LICENSE: zlib/libpng
*
*   raylib-libretro-vfs is licensed under an unmodified zlib/libpng license, which is an OSI-certified,
